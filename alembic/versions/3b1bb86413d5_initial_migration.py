...
Revision ID: 3b1bb86413d5
Revises:
Create Date: 2026-03-18 06:19:55.127717
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_job_orders_tenant_id"), "job_orders", ["tenant_id"], unique=False
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f("ix_job_orders_tenant_id"), table_name="job_orders")
